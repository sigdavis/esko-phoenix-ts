...
export class Projects extends BaseClient {
	 ...
	 * @example
	 * ```typescript
	 * const project = await client.projects.getProject('proj-456');
	 * console.log(`Project: ${project.data.name}`);
	 * ```
	 *
	 * API Route: GET /projects/{projectid}
	 */
	 ...
	 * @example
	 * ```typescript
	 * await client.projects.deleteProject('proj-456');
	 * ```
	 *
	 * API Route: DELETE /projects/{projectid}
	 */
	 ...
	 * @example
	 * ```typescript
	 * await client.projects.editProject('proj-456', {
	 *   customer: 'Updated Publisher Name',
	 *   due: '2025-12-31T23:59:59Z',
	 *   notes: 'Rush order - expedite production'
	 * });
	 * ```
	 *
	 * API Route: PATCH /projects/{projectid}
	 */
	 ...
	 * @returns Promise resolving to response entity
	 * @description Exports project data using the specified preset.
	 *
	 * @example
	 * ```typescript
	 * await client.projects.exportProject('proj-456', {
	 *   path: '/exports/project_data.xml',
	 *   preset: 'Standard Export',
	 *   overwrite: true
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/export
	 */
	...
	/**
	 * Import product into project
	 *
	 * @param projectid - Project ID
	 * @param body - Import parameters including file path
	 * @returns Promise resolving to response entity
	 * @description Imports product definitions from an external file.
	 *
	 * @example
	 * ```typescript
	 * await client.projects.importProduct('proj-456', {
	 *   path: '/imports/products.xml',
	 *   preset: 'Standard Import'
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/import/product
	 */
	...
	/**
	 * Import stock into project
	 *
	 * @param projectid - Project ID
	 * @param body - Import parameters including file path
	 * @returns Promise resolving to response entity
	 * @description Imports stock definitions from an external file.
	 *
	 * @example
	 * ```typescript
	 * await client.projects.importStock('proj-456', {
	 *   path: '/imports/stocks.xml',
	 *   preset: 'Standard Stock Import'
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/import/stock
	 */
	 ...
	 * @example
	 * ```typescript
	 * await client.projects.setProperties('proj-456', {
	 *   properties: [
	 *     { name: 'Division', type: 'String', value: 'Magazine' },
	 *     { name: 'Priority', type: 'Integer', value: 1 }
	 *   ]
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/properties
	 */
	 ...
	 * @returns Promise resolving to response entity
	 * @description Applies a library die layout to the project's products.
	 *
	 * @example
	 * ```typescript
	 * await client.projects.applyDieLayout('proj-456', {
	 *   name: 'Standard Business Card Die'
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/apply-die-layout
	 */
	 ...
	 * @example
	 * ```typescript
	 * await client.projects.applyMark('proj-456', {
	 *   name: 'Registration Marks',
	 *   side: 'Front'
	 * });
	 * ```
	 *
	 * API Route: POST /projects/{projectid}/apply-mark
	 */
